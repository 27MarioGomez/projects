...
# Cargar datos históricos mediante yfinance y aplanar columnas si es necesario
@st.cache_data
def load_crypto_data(coin_id, start_date, end_date):
    """
    Descarga datos históricos de una criptomoneda utilizando yfinance.
    Se utiliza el ticker correspondiente (ej. "BTC-USD") y se aplana el MultiIndex si fuera necesario.
    """
    ticker_ids = {
        "bitcoin": "BTC-USD",
        "ethereum": "ETH-USD",
...
def main_app():
    ...
    **Descripción del Modelo:**  
    ...
    y se obtienen noticias recientes a través de NewsAPI. Las predicciones se evalúan utilizando RMSE y MAPE, y se visualizan en gráficos interactivos.
    """)
